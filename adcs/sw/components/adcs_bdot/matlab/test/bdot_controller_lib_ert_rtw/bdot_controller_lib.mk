###########################################################################
## Makefile generated for Simulink model 'bdot_controller_lib'. 
## 
## Makefile     : bdot_controller_lib.mk
## Generated on : Mon Aug 28 20:00:01 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/bdot_controller_lib
...
PRODUCT_NAME              = bdot_controller_lib
MAKEFILE                  = bdot_controller_lib.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Taylor/uw_cubesat_adcs_2/adcs/sw/components/adcs_bdot/matlab
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = bdot_controller_lib_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/bdot_controller_lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/bdot_controller_lib_ert_rtw -I$(START_DIR) -I$(START_DIR)/test -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=bdot_controller_lib -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/bdot_controller_lib_ert_rtw/bdot_controller_lib.c $(START_DIR)/bdot_controller_lib_ert_rtw/bdot_controller_lib_data.c

MAIN_SRC = $(START_DIR)/bdot_controller_lib_ert_rtw/ert_main.c
...
OBJS = bdot_controller_lib.o bdot_controller_lib_data.o
...
%.o : $(START_DIR)/bdot_controller_lib_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bdot_controller_lib_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
