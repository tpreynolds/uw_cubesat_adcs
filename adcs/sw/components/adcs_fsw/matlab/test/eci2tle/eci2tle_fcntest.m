...
%  reci = eci position vector (meters)
...
aodp = pl / (1.0d0 - ek * ek); %% right here - ek causes aodp to be negative, inducing complex numbers
...
xmo     = RAD2DEG*xmo;
xincl   = RAD2DEG*xincl;
omegao  = RAD2DEG*omegao;
xnodeo  = RAD2DEG*xnodeo;