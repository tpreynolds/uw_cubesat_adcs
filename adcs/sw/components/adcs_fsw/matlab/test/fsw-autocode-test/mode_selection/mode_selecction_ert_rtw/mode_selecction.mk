###########################################################################
## Makefile generated for Simulink model 'mode_selecction'. 
## 
## Makefile     : mode_selecction.mk
## Generated on : Fri Oct 13 15:44:16 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mode_selecction
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_fsw/matlab/test/fsw-autocode-test/mode_selection
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mode_selecction_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mode_selecction
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/mode_selecction_ert_rtw -I$(START_DIR) -I/Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_sim/matlab/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mode_selecction -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/mode_selecction_ert_rtw/mode_selecction.c $(START_DIR)/mode_selecction_ert_rtw/mode_selecction_a.c $(START_DIR)/mode_selecction_ert_rtw/rtGetInf.c $(START_DIR)/mode_selecction_ert_rtw/rtGetNaN.c $(START_DIR)/mode_selecction_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/mode_selecction_ert_rtw/ert_main.c
...
OBJS = mode_selecction.o mode_selecction_a.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/mode_selecction_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mode_selecction_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
