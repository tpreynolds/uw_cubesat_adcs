###########################################################################
## Makefile generated for Simulink model 'mag_vector'. 
## 
## Makefile     : mag_vector.mk
## Generated on : Thu Oct 19 12:04:08 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mag_vector
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mag_vector_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mag_vector
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/mag_vector_ert_rtw -I$(START_DIR) -I/Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_sim/matlab/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mag_vector -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/mag_vector_ert_rtw/mag_vector.c $(START_DIR)/mag_vector_ert_rtw/mag_vector_data.c

MAIN_SRC = $(START_DIR)/mag_vector_ert_rtw/ert_main.c
...
OBJS = mag_vector.o mag_vector_data.o
...
%.o : $(START_DIR)/mag_vector_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mag_vector_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
