...
#include "estimate_eci_vectors.h"      /* Model's header file */
#include "rtwtypes.h"
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  estimate_eci_vectors_initialize();
  ...
  /* Terminate model */
  estimate_eci_vectors_terminate();
  return 0;
}
