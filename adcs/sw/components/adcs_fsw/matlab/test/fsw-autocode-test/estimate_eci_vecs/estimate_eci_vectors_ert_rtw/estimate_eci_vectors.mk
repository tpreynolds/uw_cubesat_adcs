...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/estimate_eci_vectors
...
PRODUCT_NAME              = estimate_eci_vectors
MAKEFILE                  = estimate_eci_vectors.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = estimate_eci_vectors_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/estimate_eci_vectors
...
DEFINES_STANDARD = -DMODEL=estimate_eci_vectors -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/estimate_eci_vectors_ert_rtw/estimate_eci_vectors.c $(START_DIR)/estimate_eci_vectors_ert_rtw/estimate_eci_vectors_data.c

MAIN_SRC = $(START_DIR)/estimate_eci_vectors_ert_rtw/ert_main.c
...
OBJS = estimate_eci_vectors.o estimate_eci_vectors_data.o
...
%.o : $(START_DIR)/estimate_eci_vectors_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/estimate_eci_vectors_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
