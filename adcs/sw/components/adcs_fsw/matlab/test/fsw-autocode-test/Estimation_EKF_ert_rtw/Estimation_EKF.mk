###########################################################################
## Makefile generated for Simulink model 'Estimation_EKF'. 
## 
## Makefile     : Estimation_EKF.mk
## Generated on : Fri Oct 13 16:08:48 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Estimation_EKF
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_fsw/matlab/test/fsw-autocode-test
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Estimation_EKF_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Estimation_EKF
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Estimation_EKF_ert_rtw -I$(START_DIR) -I/Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_sim/matlab/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Estimation_EKF -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Estimation_EKF_ert_rtw/Estimation_EKF.c $(START_DIR)/Estimation_EKF_ert_rtw/Estimation_EKF_data.c

MAIN_SRC = $(START_DIR)/Estimation_EKF_ert_rtw/ert_main.c
...
OBJS = Estimation_EKF.o Estimation_EKF_data.o
...
%.o : $(START_DIR)/Estimation_EKF_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Estimation_EKF_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
