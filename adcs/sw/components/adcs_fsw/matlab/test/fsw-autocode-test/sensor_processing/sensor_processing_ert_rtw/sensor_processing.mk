###########################################################################
## Makefile generated for Simulink model 'sensor_processing'. 
## 
## Makefile     : sensor_processing.mk
## Generated on : Sat Oct 28 15:31:45 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sensor_processing
...
PRODUCT_NAME              = sensor_processing
MAKEFILE                  = sensor_processing.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_fsw/matlab/test/fsw-autocode-test/sensor_processing
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = sensor_processing_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sensor_processing
...
INCLUDES_BUILDINFO = -I$(START_DIR)/sensor_processing_ert_rtw -I$(START_DIR) -I/Users/taylorreynolds/uw_cubesat_adcs_sourcetree/adcs/sw/components/adcs_sim/matlab/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=sensor_processing -DNUMST=7 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/sensor_processing_ert_rtw/sensor_processing.c $(START_DIR)/sensor_processing_ert_rtw/sensor_processing_data.c

MAIN_SRC = $(START_DIR)/sensor_processing_ert_rtw/ert_main.c
...
OBJS = sensor_processing.o sensor_processing_data.o
...
%.o : $(START_DIR)/sensor_processing_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/sensor_processing_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
