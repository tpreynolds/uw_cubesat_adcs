###########################################################################
## Makefile generated for Simulink model 'CDR_autocode'. 
## 
## Makefile     : CDR_autocode.mk
## Generated on : Tue Oct 31 19:48:08 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CDR_autocode
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CDR_autocode_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CDR_autocode
...
INCLUDES_BUILDINFO = -I$(START_DIR)/CDR_autocode_ert_rtw -I$(START_DIR) -I$(START_DIR)/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=CDR_autocode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/CDR_autocode_ert_rtw/CDR_autocode.c $(START_DIR)/CDR_autocode_ert_rtw/CDR_autocode_data.c

MAIN_SRC = $(START_DIR)/CDR_autocode_ert_rtw/ert_main.c
...
OBJS = CDR_autocode.o CDR_autocode_data.o
...
%.o : $(START_DIR)/CDR_autocode_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/CDR_autocode_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
