###########################################################################
## Makefile generated for MATLAB file/project 'mpcmoveCodeGeneration'. 
## 
## Makefile     : mpcmoveCodeGeneration_rtw.mk
## Generated on : Thu Nov 02 18:25:23 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpcSimCS.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/bijan/Work/CUBESA~1/MPCTES~1
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpcSimCS.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/mpcmoveCodeGeneration -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mpcSimCS -DHAVESTDIO -DUSE_RTMODEL
...
OBJS = mpcmoveCodeGeneration_initialize.obj mpcmoveCodeGeneration_terminate.obj mpcmoveCodeGeneration.obj mpcblock_optimizer.obj repmat.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
%.obj : $(START_DIR)/codegen/lib/mpcmoveCodeGeneration/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/mpcmoveCodeGeneration/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
