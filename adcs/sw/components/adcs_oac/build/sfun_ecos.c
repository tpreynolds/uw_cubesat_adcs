 ...
 *
 *         callecos(int32 u1,int32 u2,int32 u3,int32 u4,int32 u5,double u6[2],int32 u7[3],int32 u8[6],double u9[6],double u10[5],int32 u11[1],int32 u12[3],int32 u13[1],double u14[1],double u15[1],double y1[4])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 09-Feb-2019 16:49:08
 *
