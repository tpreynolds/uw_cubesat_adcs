...
% draw main blocks
\node[draw, thick, rectangle, minimum height=10cm, minimum width=8cm,align=flush right,text depth=9cm,text width=7cm, fill=uwgold!20!white] at (0,0) {\bf SOAR};
\node[draw, thick, rectangle, minimum height=4cm, minimum width=2.75cm, text width=2.5cm,align=flush left,name=soar] at (-1.75,0) {};
\node[text width=2.5cm,anchor=north] at (soar.north) {SOLVE};
\node[text width=2.5cm,align=flush left] at (soar) {\begin{tabular}{l}
...
\end{tabular}};
\node[draw, thick, rectangle, minimum height=4cm, minimum width=2.75cm,text width=2.5cm,align=flush left,name=interp] at (1.75,0) {};
