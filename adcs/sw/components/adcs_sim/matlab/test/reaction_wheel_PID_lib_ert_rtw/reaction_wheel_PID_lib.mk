###########################################################################
## Makefile generated for Simulink model 'reaction_wheel_PID_lib'. 
## 
## Makefile     : reaction_wheel_PID_lib.mk
## Generated on : Mon Aug 28 20:37:27 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/reaction_wheel_PID_lib
...
PRODUCT_NAME              = reaction_wheel_PID_lib
MAKEFILE                  = reaction_wheel_PID_lib.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_sim/matlab/test
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = reaction_wheel_PID_lib_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/reaction_wheel_PID_lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/reaction_wheel_PID_lib_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=reaction_wheel_PID_lib -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/reaction_wheel_PID_lib_ert_rtw/reaction_wheel_PID_lib.c

MAIN_SRC = $(START_DIR)/reaction_wheel_PID_lib_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/reaction_wheel_PID_lib_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/reaction_wheel_PID_lib_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
